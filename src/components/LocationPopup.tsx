...
function PhotoCarousel({
  ...
  return (
    ...
    >
            ...
            <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5">
              {photos.map((_, i) => (
                <button
                  ...
                  className={`rounded-full transition-all cursor-pointer w-2.5 h-2.5 p-1.5 ${
                    i === activePhoto
                      ? "bg-white scale-125"
      ...
      <span className="absolute bottom-2 right-2 text-[10px] text-white/90 bg-black/50 px-1.5 py-0.5 rounded">
  ...
  return (
    <div className="border-t border-brand-border pt-2 mt-2">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-[10px] text-brand-text/60 ml-auto">
          {review.timeAgo}
        </span>
      </div>
      ...
      {review.text && (
        <p className="text-[11px] text-brand-text/70 leading-relaxed line-clamp-3">
          {review.text}
        </p>
      )}
    </div>
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-wrap mb-2">
        ...
        {enrichment?.priceLevel && (
          <span className="text-[11px] text-brand-text/70 font-medium">
            {enrichment.priceLevel}
          </span>
        )}
      </div>
